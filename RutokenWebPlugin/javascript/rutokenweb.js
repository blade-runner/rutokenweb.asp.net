var rutokenweb = (function (my) {
    ...
    function initialize() {
        ...
        window.rutokenwebLoaded = onPluginLoaded;
    }
    ...
    function initializeChrome() {
        var readyPromise = extension.initialize().then(function () {
            ...
            if (result) {
                pluginMimeType = "application/x-rutoken2";
    ...
    function loadPlugin() {
        ...
        obj.innerHTML = "<param name='onload' value='rutokenwebLoaded'/>";
    ...
    if (extension) {
        ...
        try {
            var plugin = new ActiveXObject("AktivCo.rutoken");
            initialize();
        } catch (e) {
